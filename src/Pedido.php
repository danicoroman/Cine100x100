...
class Pedido{
    ...
    public function mostrar(){
        $sql = "SELECT p.id, nombre, apellidos, mail, total, fecha FROM pedidos p
    ...
    public function mostrarPorId($id){
                $sql = "SELECT p.id, nombre, apellidos, mail, total, direccion_facturacion, fecha FROM pedidos p
